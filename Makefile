...
{%- endif %}
	...
	@echo "  RUN_TYPE          - Determines how safety check issues are handled:"
	@echo "        normal        - Branch push / PR creation / PR merge: tolerant"
	@echo "        scheduled     - Actions scheduled test: tolerant for develop, strict for install"
	@echo "        release       - Package release: strict"
	@echo "        local         - Local workstation run: strict"
	@echo "      Optional, defaults to 'local'."
